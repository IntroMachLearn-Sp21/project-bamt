...
boundaries = [([17, 15, 50], [60, 66, 255]), ([22, 93, 0], [100,255,255]), ([50,0,0], [230,255,60])] #([17, 15, 100], [50, 56, 200]), ([100, 0, 100], [255,50,255]) ([25, 146, 190], [62, 174, 250]) ([0, 100, 0], [250, 200, 250])
#hundred = 100
#twohun = 200
#image = cv2.cvtColor(image,cv2.COLOR_BGR2RGB)
color = []
